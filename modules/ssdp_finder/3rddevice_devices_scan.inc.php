...
function Scan_3rddevice()
    ...
    $table_name = 'ssdp_devices';
	    ...
	    if ($deviceInfo['Body']['ProbeMatches']['ProbeMatch']['XAddrs']) {
            // если устройство Хромекаст
                $control_url = ['Body']['ProbeMatches']['ProbeMatch']['XAddrs'];
                // проверяем на наличие в базе для запрета вывода
                $uuid = $deviceInfo['Body']['ProbeMatches']['ProbeMatch']['EndpointReference']['Address'] ;
